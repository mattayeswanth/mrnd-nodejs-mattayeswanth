...
var getContactFileName = function(id) {
    ...
    return "C://Users//user//Downloads//mrnd-nodejs-master (1)//mrnd-nodejs-master//spec//tests//data//" + id + "-Contact.json";
}

var getmessagefilename = function (id) {
    return "C://Users//user//Downloads//mrnd-nodejs-master (1)//mrnd-nodejs-master//spec//tests//data//" + id + "messages" + "-Contact.json";
}
...
describe("FilePersistence Test Suite", function(){
	...
	describe("post and get message to contact", function(){
		...
		it("should get message for contact", function(done){
		    //TODO: Write your test case here.idCreated = 0;

                    var fileName = getmessagefilename(idCreated);

                    var obj = JSON.parse(fs.readFileSync(fileName));
                    expect(obj.message).toBe("hai")
                    done();
